...
const Users = mongoose.model('User', userSchema); // Rename User to Users
...
app.post('/users', async (req, res) => {
  try {
    const newUser = new Users({ ...req.body }); // Change here
...
app.put('/users/:id', async (req, res) => {
  try {
    ...
    const updatedUserMongo = await Users.findByIdAndUpdate(id, updatedUser, { new: true }); // Change here
...
app.delete('/users/:id', async (req, res) => {
  try {
    ...
    await Users.findByIdAndDelete(id); // Change here
...
app.put('/users/:id/toggle-status', async (req, res) => {
  try {
    ...
    const user = await Users.findById(id); // Change here
    if (!user) {
