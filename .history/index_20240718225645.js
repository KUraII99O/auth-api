...
app.post("/pregnancies", (req, res) => {
  ...
  // Add the pregnancy to the pregnancies array
  pregnancies.push(newPregnancy);
...
app.get("/pregnancies", (req, res) => {
  ...
  let filteredPregnancies = pregnancies;

  if (userId) {
    filteredPregnancies = filteredPregnancies.filter((pregnancy) => pregnancy.userId === userId);
  }

  if (animalId) {
    filteredPregnancies = filteredPregnancies.filter((pregnancy) => pregnancy.animalId === animalId);
  }
